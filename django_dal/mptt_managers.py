...
class DALTreeManager(models.Manager.from_queryset(DALTreeQuerySet)):
    ...
    def contribute_to_class(self, model, name):
        super(DALTreeManager, self).contribute_to_class(model, name)
    ...
    def disable_mptt_updates(self):
        ...
        When to use this method:
            ...
            should follow this method with a call to ``DALTreeManager.rebuild()``
    ...
    def delay_mptt_updates(self):
        ...
        When to use this method:
            ...
            *very* slow.
            ...
            ``DALTreeManager.disable_mptt_updates``, as it does much fewer
            queries.
